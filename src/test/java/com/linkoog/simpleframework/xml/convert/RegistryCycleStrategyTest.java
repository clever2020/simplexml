...
public class RegistryCycleStrategyTest extends ValidationTestCase {
   ...
   public static class PetBucket {
      ...
      private List<ExampleConverters.Pet> list = new ArrayList<ExampleConverters.Pet>();
      public void addPet(ExampleConverters.Pet pet){
         list.add(pet);
      }
      public List<ExampleConverters.Pet> getPets(){
         return list;
      }
   }
   ...
   public void testCycle() throws Exception {
      ...
      ExampleConverters.Pet kitty = new ExampleConverters.Cat("Kitty", 10);
      ExampleConverters.Pet lassie = new ExampleConverters.Dog("Lassie", 7);
      ExampleConverters.Pet ben = new ExampleConverters.Dog("Ben", 8);
      ...
      assertElementHasAttribute(text, "/petBucket/pet[1]", "class", ExampleConverters.Cat.class.getName());
      assertElementHasAttribute(text, "/petBucket/pet[2]", "class", ExampleConverters.Dog.class.getName());
   }

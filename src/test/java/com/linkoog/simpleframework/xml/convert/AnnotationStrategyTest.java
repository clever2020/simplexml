...
public class AnnotationStrategyTest extends ValidationTestCase {
   ...
   private static class FarmExample {
      ...
      @Convert(ExampleConverters.ChickenConverter.class)
      private ExampleConverters.Chicken chicken;
      
      @Element
      @Convert(ExampleConverters.CowConverter.class)
      private ExampleConverters.Cow cow;
      ...
      public FarmExample(@Element(name="chicken") ExampleConverters.Chicken chicken, @Element(name="cow") ExampleConverters.Cow cow) {
      ...
      public ExampleConverters.Chicken getChicken() {
         return chicken;
      }
      public ExampleConverters.Cow getCow() {
         return cow;
      }
   }
